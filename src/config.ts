...
export const deployNftMinterGasLimit =
  customConfig?.config?.nftMinterSc?.deployGasLimit || 600000000;
...
export const giveawayTxBaseGasLimit =
  customConfig?.config?.nftMinterSc?.giveawayBaseGasLimit || 11000000;
...
export const shuffleGasLimit =
  customConfig?.config?.nftMinterSc?.shuffleGasLimit || 600000000;
...
export const populateIndexesBaseTxGasLimit =
  customConfig?.config?.nftMinterSc?.populateIndexesBaseGasLimit || 120000;
